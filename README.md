...
приватным. Кроме того, ключи работают и в обратную сторону: Вы можете
подписать сообщение приватным ключом, а кто угодно &mdash; проверить подпись
публичным и убедиться, что сообщение написали именно Вы и его никто не менял:
...
А вот безопасность растёт и возможно хранить секреты текущие технологии умеют
достаточно хорошо.
